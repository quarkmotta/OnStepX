...
#define PINMAP                        RP2040_ZERO //    OFF, Choose from: MiniPCB, MiniPCB2, MaxPCB4, MaxESP4, MaxSTM3, FYSETC_E4,   <-Req'd
...
//#define MATRIX_STATUS_LED                    ON //    OFF, Steady use  WS2812/NeoPixel matrix led.          Option
...
#define AXIS1_DRIVER_MICROSTEPS       16 //    OFF, n. Default microstep mode.                                              <-Req'd
...
#define AXIS2_DRIVER_MICROSTEPS       16 //    OFF, n. Default microstep mode.                                              <-Req'd
